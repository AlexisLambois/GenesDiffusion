...
def row_to_prelevement(row):
    return Prelevement(row[0], row[1], row[2], row[3], row[4], row[5], row[6], row[7], row[8], row[9],row[10],row[11],row[12],row[13],row[14],row[15],row[16],row[17])
...
class PrelevementManager(object):
    ...
    @staticmethod
    def get_prelevement_sous_requete(tosql,sous_requete):
        return DatabaseManager.select_prelevement_sous_requete(tosql,sous_requete)
    ...
    @staticmethod
    def get_prelevement_to_html(tab_id):
       return DatabaseManager.select_prelevement_to_html(tab_id)
