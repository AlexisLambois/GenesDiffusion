...
class AnimalManager(object):
    ...
    @staticmethod
    def get_animal_by(tosql):
        animals = []
        data = DatabaseManager.select_animal_by(tosql)
        for row in data:
    ...
    @staticmethod
    def get_animal_sous_requete(tosql,sous_requete):
        return DatabaseManager.select_animal_sous_requete(tosql, sous_requete)